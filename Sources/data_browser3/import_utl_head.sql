...
IS
	...
	TYPE rec_table_imp_fk IS RECORD (
		...
		FOLDER_CONTAINER_COLUMN_NAME VARCHAR2(512),
...
CREATE OR REPLACE VIEW VUSER_TABLES_IMP (TABLE_NAME, VIEW_NAME, IMPORT_TABLE_NAME, IMPORT_VIEW_NAME,
	...
	IMP_TABLE_EXISTS, HAS_SCALAR_PRIMARY_KEY, IS_REFERENCED, SEARCH_KEY_COLS,
...
AS
  WITH TABLES_Q AS (
		SELECT S.TABLE_NAME, S.VIEW_NAME, S.SHORT_NAME || '_IMP' IMP_TABLE_NAME,
				...
				S.HAS_SCALAR_PRIMARY_KEY, S.SEARCH_KEY_COLS,
		...
		GROUP BY S.TABLE_NAME, S.VIEW_NAME, S.SHORT_NAME, S.IMP_TABLE_NAME, S.HAS_SCALAR_PRIMARY_KEY,
			S.SEARCH_KEY_COLS, S.DESCRIPTION_COLUMNS
	), COLUMNS_Q AS (
