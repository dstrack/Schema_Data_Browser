...
$END
	...
	update DATA_BROWSER_CHECKS set CHECKED_GUI_GET = 'N'
	where CHECKED_GUI_PUT IN ('N', 'X')
	AND CHECKED_GUI_GET = 'Y'
	AND (CHECK_GUI_IMP_RELEVANT = 'Y'
	OR CHECK_GUI_PUT_RELEVANT = 'Y'); 	
	commit;
	*/
	PROCEDURE Mark_GUI_Test_Case (
		p_Sequence_ID IN NUMBER,
