...
IS
	...
	IS
        ...
        CURSOR user_keys_cur
        IS
			SELECT C.TABLE_NAME, SYS_CONTEXT('USERENV', 'CURRENT_SCHEMA') TABLE_OWNER, C.CONSTRAINT_NAME, B.CONSTRAINT_TYPE, C.COLUMN_NAME, C.POSITION,
				D.DATA_DEFAULT DEFAULT_TEXT,
				D.DATA_TYPE, D.NULLABLE, D.DATA_PRECISION, D.DATA_SCALE, D.CHAR_LENGTH,
				B.INDEX_OWNER, B.INDEX_NAME, B.DEFERRABLE, B.DEFERRED, B.STATUS, B.VALIDATED
	...
	IS
        ...
        CURSOR user_keys_cur
        IS
			SELECT C.TABLE_NAME, SYS_CONTEXT('USERENV', 'CURRENT_SCHEMA') TABLE_OWNER, 
