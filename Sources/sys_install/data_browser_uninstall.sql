...
BEGIN
    ...
    DROP_MVIEW('MVCHANGELOG_REFERENCES'); -- old mview
...
BEGIN
    ...
    RUN_STAT('DROP PACKAGE DATA_BROWSER_CTL');
    ...
    if v_Schema_Keychain_Exists > 0 then
        ...
        RUN_STAT('DROP VIEW VDATA_BROWSER_USERS');
    ...
    CHECKED_DROP('VIEW', 'V_ERROR_PROTOCOL');
    CHECKED_DROP('VIEW', 'VDATA_BROWSER_USERS');
    ...
    CHECKED_DROP('FUNCTION', 'FN_PIPE_BASE_UNIQUEKEYS');
    CHECKED_DROP('FUNCTION', 'CHANGELOG_VALUES'); -- old name
    ...
    CHECKED_DROP('PACKAGE', 'API_TRACE');
