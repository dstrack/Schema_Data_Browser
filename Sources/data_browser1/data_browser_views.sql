...
FROM (
	...
	FROM (
        ...
        , (
			SELECT B.TABLE_OWNER, B.TABLE_NAME, B.COLUMN_NAME, B.CHECK_CONDITION,
				B.CHECK_UNIQUE, B.IS_FOREIGN_KEY, B.IS_REFERENCE,
				DENSE_RANK() OVER (PARTITION BY B.TABLE_OWNER, B.TABLE_NAME, B.COLUMN_NAME ORDER BY B.CONSTRAINT_NAME) RANK
