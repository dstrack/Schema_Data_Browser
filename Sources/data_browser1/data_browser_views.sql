...
CREATE MATERIALIZED VIEW MVDATA_BROWSER_U_REFS (
	VIEW_NAME, TABLE_NAME, TABLE_OWNER, COLUMN_NAME, POSITION, NULLABLE, DATA_TYPE, 
	DATA_PRECISION, DATA_SCALE, CHAR_LENGTH, U_CONSTRAINT_NAME, U_MEMBERS, MATCHING, 
    ...
    REFRESH COMPLETE
    ON DEMAND
AS select VIEW_NAME, TABLE_NAME, TABLE_OWNER, COLUMN_NAME, POSITION, NULLABLE, DATA_TYPE, 
	DATA_PRECISION, DATA_SCALE, CHAR_LENGTH, U_CONSTRAINT_NAME, U_MEMBERS, MATCHING, 
	HAS_NULLABLE, CONSTRAINT_TYPE, INDEX_OWNER, INDEX_NAME, RANK
...
FROM (
	...
	FROM (
		...
		FROM (
            ...
            JOIN TABLE ( data_browser_pipes.FN_Pipe_Foreign_Key_Columns ) F ON S.TABLE_NAME = F.TABLE_NAME AND S.TABLE_OWNER = F.TABLE_OWNER
		) F
