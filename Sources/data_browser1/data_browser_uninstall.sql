...
BEGIN
    ...
    RUN_STAT('DROP VIEW VUSER_TABLES_IMP_TRIGGER');
    RUN_STAT('DROP VIEW VUSER_TABLES_IMP_COLUMNS');
    RUN_STAT('DROP VIEW VUSER_TABLES_IMP_LINK');
    ...
    RUN_STAT('DROP VIEW VDATA_BROWSER_JOBS_CACHED');
    ...
    if v_Schema_Keychain_Exists > 0 then
        ...
        RUN_STAT('DROP VIEW VBASE_VIEWS0');
        RUN_STAT('DROP VIEW VBASE_VIEWS');
