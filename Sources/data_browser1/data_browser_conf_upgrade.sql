...
BEGIN
    ...
    RUN_STAT('DROP PROCEDURE Data_Browser_Vis_Local_Launch_Job'); -- old name
    RUN_STAT('DROP PROCEDURE Data_Browser_Vis_Upd_Local'); -- old name
    RUN_STAT('DROP PROCEDURE Data_Browser_Visitors_Launch_Job'); -- old name
    RUN_STAT('DROP PROCEDURE Data_Browser_Vis_Upd'); -- old name
    RUN_STAT('DROP TABLE DATA_BROWSER_VISITORS'); -- old name
    RUN_STAT('DROP FUNCTION APPVISITOR_REST'); -- old name
    RUN_STAT('DROP TYPE APPVISITOR_TABLE_T'); -- old name
    RUN_STAT('DROP TYPE APPVISITOR_ROW_T'); -- old name
    RUN_STAT('DROP VIEW DATA_BROWSER_VISITORS_V'); -- old name
