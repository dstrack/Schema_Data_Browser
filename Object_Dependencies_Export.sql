...
WITH PARAM AS ( 
	...
	AND (TA.OWNER IS NULL 
		OR (NOT(TA.OWNER = 'SYS' AND TA.OBJECT_NAME IN ('DBMS_STANDARD', 'STANDARD'))
		AND NOT(TA.OWNER = 'PUBLIC' AND TA.OBJECT_NAME IN ('DUAL')))
	)
	AND (SO.OWNER IS NULL 
		OR (NOT(SO.OWNER = 'SYS' AND SO.OBJECT_NAME IN ('DBMS_STANDARD', 'STANDARD'))
		AND NOT(SO.OWNER = 'PUBLIC' AND SO.OBJECT_NAME IN ('DUAL')))
	)
...
FROM APP_OBJECT_DEPENDENCIES_V
WHERE OBJECT_NAME IS NOT NULL;
